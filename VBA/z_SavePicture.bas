...
' z_SavePicture.SavePicture xlPicture
' Kill2 (ThisWorkbook.Path & "\temp.emf")
...
Sub test123()
Sheets(SN_Output).Shapes("EMF10").Copy
SavePicture xlPicture
End Sub
...
'''
Function SavePicture(Optional lXlPicType As Long = xlPicture) As Boolean
    'Some pointers
    ...
    If hPicAvail <> 0 Then
        ...
        If h > 0 Then
            ...
            If hPtr <> 0 Then
                ...
                stdole.SavePicture IPic, Environ("Temp") & "\temp.emf"
            End If
        End If
    End If
End Function
